...
train_path = "/opt/ml/level3_nlp_finalproject-nlp-11/T5/paraphrase_data/Quora_Paraphrasing_train.csv"
val_path = "/opt/ml/level3_nlp_finalproject-nlp-11/T5/paraphrase_data/Quora_Paraphrasing_val.csv"
...
if not os.path.exists('t5_reparaphrase'):
    os.makedirs('t5_reparaphrase')
...
print ("Saving model")
model.model.save('t5_reparaphrase')
