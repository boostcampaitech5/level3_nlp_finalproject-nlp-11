...
if __name__ == "__main__":
    ...
    parser.add_argument('--query_list_path', type=str, default="DensePhrases/densephrases-data/open-qa/nq-open/test_preprocessed_changed_with_gpt.json",
    ...
    parser.add_argument('--using_t5_type', type=str, default=None,
                        help="Specify the T5 model for query expansion(small or base or large)")
    ...
    if args.single_query is None:
        ...
        #여기서 queries를 T5로 rephrased
        if args.using_t5_type is not None:
            queries = changed_with_t5(queries,args.using_t5_type)
        inputs = {
            'queries': queries,
            'qids': qids,
        }
